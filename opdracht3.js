...
//tijdelijk: //Opdracht 3b: Schrijf de code uit 3a om naar een functie die een array met tv-objecten verwacht. Het is handig om onze scripts als functies op te zetten, zodat we ze gemakkelijk kunnen hergebruiken. Tip: vergeet deze functie -declaratie niet aan te roepen!
//
function getTvBrands() {
       return inventory.map((tv) => {
            return brands.innerHTML += `<li>${tv.brand}</li>`
        })
}
